...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.countIt = function () {
        ...
        setTimeout(function () {
            ...
            _this.seconds = (minutsLeft - Math.floor(minutsLeft)) * 60;
            // this.seconds = secondsLeft - this.seconds;
            console.log("seconds : " + _this.seconds);
            var days = daysLeft;
            _this.daysX = Math.floor(daysLeft);
            _this.hoursX = Math.floor(hours);
            _this.minsX = Math.floor(minutes);
            _this.secX = _this.seconds;
            // if(days<=0) {days=0;}
            // if(hours<=0) {hours=0;}
...
var LANG_FR_TRANS = {
    ...
    '21:00-23:00 Drinks at the Bar - Esterel Resort': '21:00-23:00 Drinks au Bar - Estérel',
